...
export const TagApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getTags(requestParameters: TagApiGetTagsRequest, options?: AxiosRequestConfig): AxiosPromise<PaginatedTags> {
...
export class TagApi extends BaseAPI {
    ...
    public getTags(requestParameters: TagApiGetTagsRequest, options?: AxiosRequestConfig) {
        return TagApiFp(this.configuration).getTags(requestParameters.teamName, requestParameters.page, requestParameters.perPage, options).then((request) => request(this.axios, this.basePath));
    }
}
