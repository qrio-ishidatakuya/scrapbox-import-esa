...
export const MemberApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        deleteMember(requestParameters: MemberApiDeleteMemberRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        getMembers(requestParameters: MemberApiGetMembersRequest, options?: AxiosRequestConfig): AxiosPromise<PaginatedMembers> {
...
export class MemberApi extends BaseAPI {
     ...
     * @memberof MemberApi
     */
    public deleteMember(requestParameters: MemberApiDeleteMemberRequest, options?: AxiosRequestConfig) {
        return MemberApiFp(this.configuration).deleteMember(requestParameters.teamName, requestParameters.screenName, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof MemberApi
     */
    public getMembers(requestParameters: MemberApiGetMembersRequest, options?: AxiosRequestConfig) {
        return MemberApiFp(this.configuration).getMembers(requestParameters.teamName, requestParameters.sort, requestParameters.order, requestParameters.page, requestParameters.perPage, options).then((request) => request(this.axios, this.basePath));
    }
}
