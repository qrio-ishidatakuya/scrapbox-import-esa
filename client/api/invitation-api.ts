...
export const InvitationApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        disinvite(requestParameters: InvitationApiDisinviteRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        getInvitations(requestParameters: InvitationApiGetInvitationsRequest, options?: AxiosRequestConfig): AxiosPromise<InvitationList> {
         ...
         * @throws {RequiredError}
         */
        invite(requestParameters: InvitationApiInviteRequest, options?: AxiosRequestConfig): AxiosPromise<InvitationList> {
...
export class InvitationApi extends BaseAPI {
     ...
     */
    public disinvite(requestParameters: InvitationApiDisinviteRequest, options?: AxiosRequestConfig) {
        return InvitationApiFp(this.configuration).disinvite(requestParameters.teamName, requestParameters.code, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof InvitationApi
     */
    public getInvitations(requestParameters: InvitationApiGetInvitationsRequest, options?: AxiosRequestConfig) {
        return InvitationApiFp(this.configuration).getInvitations(requestParameters.teamName, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof InvitationApi
     */
    public invite(requestParameters: InvitationApiInviteRequest, options?: AxiosRequestConfig) {
        return InvitationApiFp(this.configuration).invite(requestParameters.teamName, requestParameters.inviteBody, options).then((request) => request(this.axios, this.basePath));
    }
}
